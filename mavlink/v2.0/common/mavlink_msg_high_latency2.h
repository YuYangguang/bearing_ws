...
typedef struct __mavlink_high_latency2_t {
 ...
 uint16_t target_distance; /*< [dam] Distance to target waypoint or position (meters / 10)*/
 ...
 uint8_t heading; /*< [deg/2] Heading (degrees / 2)*/
 uint8_t target_heading; /*< [deg/2] Heading setpoint (degrees / 2)*/
 uint8_t throttle; /*< [%] Throttle (percentage)*/
 uint8_t airspeed; /*< [m/s*5] Airspeed (m/s * 5)*/
 uint8_t airspeed_sp; /*< [m/s*5] Airspeed setpoint (m/s * 5)*/
 uint8_t groundspeed; /*< [m/s*5] Groundspeed (m/s * 5)*/
 uint8_t windspeed; /*< [m/s*5] Windspeed (m/s * 5)*/
 uint8_t wind_heading; /*< [deg/2] Wind heading (deg / 2)*/
 uint8_t eph; /*< [dm] Maximum error horizontal position since last message (m * 10)*/
 uint8_t epv; /*< [dm] Maximum error vertical position since last message (m * 10)*/
 int8_t temperature_air; /*< [degC] Air temperature (degrees C) from airspeed sensor*/
 int8_t climb_rate; /*< [dm/s] Maximum climb rate magnitude since last message (m/s * 10)*/
 ...
 * @param heading [deg/2] Heading (degrees / 2)
 * @param target_heading [deg/2] Heading setpoint (degrees / 2)
 * @param target_distance [dam] Distance to target waypoint or position (meters / 10)
 * @param throttle [%] Throttle (percentage)
 * @param airspeed [m/s*5] Airspeed (m/s * 5)
 * @param airspeed_sp [m/s*5] Airspeed setpoint (m/s * 5)
 * @param groundspeed [m/s*5] Groundspeed (m/s * 5)
 * @param windspeed [m/s*5] Windspeed (m/s * 5)
 * @param wind_heading [deg/2] Wind heading (deg / 2)
 * @param eph [dm] Maximum error horizontal position since last message (m * 10)
 * @param epv [dm] Maximum error vertical position since last message (m * 10)
 * @param temperature_air [degC] Air temperature (degrees C) from airspeed sensor
 * @param climb_rate [dm/s] Maximum climb rate magnitude since last message (m/s * 10)
 ...
 *
 * @return [deg/2] Heading (degrees / 2)
 */
 ...
 *
 * @return [deg/2] Heading setpoint (degrees / 2)
 */
 ...
 *
 * @return [dam] Distance to target waypoint or position (meters / 10)
 */
 ...
 *
 * @return [m/s*5] Airspeed setpoint (m/s * 5)
 */
 ...
 *
 * @return [m/s*5] Groundspeed (m/s * 5)
 */
 ...
 *
 * @return [deg/2] Wind heading (deg / 2)
 */
 ...
 *
 * @return [dm] Maximum error horizontal position since last message (m * 10)
 */
 ...
 *
 * @return [dm] Maximum error vertical position since last message (m * 10)
 */
 ...
 *
 * @return [dm/s] Maximum climb rate magnitude since last message (m/s * 10)
 */
