...
struct BATTERY_STATUS : mavlink::Message {
    ...
    std::array<uint16_t, 10> voltages; /*< [mV] Battery voltage of cells, in millivolts (1 = 1 millivolt). Cells above the valid cell count for this battery should have the UINT16_MAX value. */
