...
//    ros::Time::init();
//    Formation this_formation(argc,argv,"formation_node");
//    ros::spin();
//    return 0;
...
int main(int argc, char **argv)
{
   ...
   ros::Publisher bodyAxisVelocityPublisher = nh.advertise<geometry_msgs::TwistStamped>("/uav1/mavros/setpoint_velocity/cmd_vel",10);
